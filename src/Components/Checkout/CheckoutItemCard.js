...
const CheckoutItemCard = (props) => {
    ...
    return (
        <div className="pb-6 mb-20 bg-[#F9F7F1] flex items-end relative">
            <div className="flex flex-row gap-12 items-center justify-center p-8 rounded-2xl py-10 px-14">
                ...
                <div className="flex flex-col justify-center items-center">
                    <div className="flex items-center justify-center">
                        ...
                        <h2 className="text-4xl font-semibold px-2">{getItemQty}</h2>
                    </div>
                    <button className="text-[32px] font-semibold pb-2 px-10 rounded-2xl underline text-[#808080]"><Link to="/cart">Change</Link></button> 
                </div>
            </div> 
